...
{
    public static function validateProductRequestForAdmin(Request $request)
    {
        $rules = [
            'name' => 'required',
    ...
    public static function makeUniqueSlugForAdmin($baseSlug)
    {
        $newSlug = $baseSlug;
        $counter = 1;
    ...
    public static function handleAdminProductImage($request, $productData)
    {
